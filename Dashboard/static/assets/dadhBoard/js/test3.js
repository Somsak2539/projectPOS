// ------------------------------------------------------------------------------การทดสอบ Api------------------------------------------------
const apiUrl = "http://[2001:44c8:42c5:f5a6:8333:a098:14e6:42b8]:8080/blog/list/";
...
// ✅ แสดงผลรวมของราคา
    ...
    maximumFractionDigits: 2
      ...
      const All = sumNeauyang + sumSankor + sumSaiOn + sumSaiYai + sumSiKhorongMu + sumLaiMu + sumSanNok + sumSamChan + sumKradukChup + sumMomot + totalPrice1;
      ...
      if (displayVlave === "0") {
        ...
        document.querySelectorAll("button").forEach(btn => {
          if (btn.id !== "row22") { // ยกเว้นปุ่ม Clean
        ...
        fetch("http://[2001:44c8:42c5:f5a6:8333:a098:14e6:42b8]:8080/update-stock/", {
          method: "PUT",
          headers: {
          ...
          .then((data) => {///------------------------ขอโน็ตไว้ก่อนน่ะ---------------------------
            ...
            fetch("http://[2001:44c8:42c5:f5a6:8333:a098:14e6:42b8]:8080/save-sale-record/", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
...
console.log("ทดสอบ api การทำงาน",ArrayBarcode)
    ...
    function comlum22() {
      ...
      fetch("http://[2001:44c8:42c5:f5a6:8333:a098:14e6:42b8]:8080/Dashboard/", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
